local invisible_combinator = copyPrototype("programmable-speaker", "programmable-speaker", "invisible-combinator")
	invisible_combinator.icon = MOD_NAME.."/graphics/invisible-combinator-item.png"
	...
	invisible_combinator.sprite = 
	{
      ...
      {
		{
			filename = MOD_NAME.."/graphics/invisible-combinator-entity.png",
			x = 158,
			y = 5,
			width = 79,
			height = 63,
...
local invisible_combinator_input = copyPrototype("programmable-speaker", "programmable-speaker", "invisible-combinator-input")
	invisible_combinator_input.energy_usage_per_tick = "1W"
	invisible_combinator_input.icon = MOD_NAME.."/graphics/invisible-combinator-input-item.png"
	...
	invisible_combinator_input.sprite =
		{
		  ...
		  {
			{
			  filename = MOD_NAME.."/graphics/invisible-combinator-input-entity.png",
			  priority = "extra-high",
			  width = 30,
			  height = 89,
			  shift = util.by_pixel(-2, -39.5),
			  hr_version = {
				filename = MOD_NAME.."/graphics/hr-invisible-combinator-input-entity.png",
				priority = "extra-high",
				width = 59,
				height = 178,
			...
			{
			  filename = MOD_NAME.."/graphics/invisible-combinator-input-entity-shadow.png",
			  priority = "extra-high",
			  width = 119,
			  height = 25,
...
local invisible_combinator_output = copyPrototype("constant-combinator", "constant-combinator", "invisible-combinator-output")
	invisible_combinator_output.icon = MOD_NAME.."/graphics/invisible-combinator-output-item.png"
	invisible_combinator_output.icon_size = 32
	invisible_combinator_output.sprites = 
		{
		  north =
		  {
			filename = MOD_NAME.."/graphics/invisible-combinator-output-entity.png",
			x = 158,
			y = 5,
			width = 79,
			height = 63,
...
--------
--local invisible_combinator = copyPrototype("item", "constant-combinator", "invisible-combinator")
--	invisible_combinator_input.icon = MOD_NAME.."/graphics/invisible-combinator-item.png"
--
--local invisible_combinator_output = copyPrototype("item", "constant-combinator", "invisible-combinator-input")
--	invisible_combinator_input.icon = MOD_NAME.."/graphics/invisible-combinator-input-item.png"
--	
--local invisible_combinator_output = copyPrototype("item", "constant-combinator", "invisible-combinator-output")
--	invisible_combinator_input.icon = MOD_NAME.."/graphics/invisible-combinator-output-item.png"
--------


--addTechnologyUnlocksRecipe("circuit-network","invisible-combinator")
--addTechnologyUnlocksRecipe("circuit-network","invisible-combinator-input")
--addTechnologyUnlocksRecipe("circuit-network","invisible-combinator-output")
