...
switchbutton.icon = "__Lo_Switch_Button__/graphics/Switch_Button_OFF.png"
switchbutton.icon_size = 40
--switchbutton.minable.result = "constant-combinator"

local sprite = {
  filename = "__Lo_Switch_Button__/graphics/Switch_Button_OFF.png",
  width = 40,
  height = 40,
  frame_count = 1,
  shift = {0.0, 0.0},
...
local activity_led_sprite = {
  filename = "__Lo_Switch_Button__/graphics/Switch_Button_ON.png",
  width = 40,
  height = 40,
  frame_count = 1,
