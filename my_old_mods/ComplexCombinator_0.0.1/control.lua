...
function gui_operand(parent, line)
	layout = gui_element(parent, {type="flow", name="flow1", direction="vertical" })
	gui_element(parent, {type="button", name="button", caption="+", style="complex_combinator_op_button"})
	gui_element(parent, {type="textfield", name="textbox", style="complex_combinator_textbox"})
...
--				debug_log("Inside Complex Combinator opened", 0)
				...
				table_layout = gui_element(complex_combinator_frame,{type="table", name="table_layout", colspan=6})

				gui_element(table_layout, {type="label", name="lb06", caption="Out"})
				gui_element(table_layout, {type="label", name="lb01", caption="Op A"})
				gui_element(table_layout, {type="label", name="lb02", caption="A"})
				gui_element(table_layout, {type="label", name="lb03", caption="Op"})
				gui_element(table_layout, {type="label", name="lb04", caption="Op B"})
				gui_element(table_layout, {type="label", name="lb05", caption="B"})

				gui_element(table_layout, {type="textfield", name="tf01", style="complex_combinator_textbox"})
				gui_element(table_layout, {type="textfield", name="tf02", style="complex_combinator_textbox"})
				
				--gui_element(table_layout, {type="textfield", name="tf03", style="complex_combinator_textbox"})
				
				gui_operand(table_layout, "1")
				
				gui_element(table_layout, {type="textfield", name="tf04", style="complex_combinator_textbox"})
				gui_element(table_layout, {type="textfield", name="tf05", style="complex_combinator_textbox"})
				gui_element(table_layout, {type="textfield", name="tf06", style="complex_combinator_textbox"})

				--gui_element(layout1, {type="sprite", name="lolo_but", SpritePath={"__base__/graphics/icons/signal/signal_1.png"}})
				gui_element(complex_combinator_frame, {type="button", name="lolo_save2", caption="TEST button2" })
				
				-- gui_element(player_gui, {type="frame", name="lolo_frame", caption={"msg-window-title"}, direction="vertical" })
				
				--__base__/graphics/icons/signal/signal_1.png
				
--				gui_element(player_gui, {type="button", name="lolo_save", caption="TEST button" })

--				gui = gui_element(player_gui, {type="frame", name="lua_lamp", caption={"msg-window-title"}, direction="vertical" })
--				checkboxes = gui_element(gui,{type="flow", name="checkboxes", direction="horizontal"})
--				lua_save = gui_element(gui, {type="button", name="lua_save", caption={"msg-button-save"}})
