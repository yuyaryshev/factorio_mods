...
--tank-rockets
  {
    ...
    animation =
    {
      filename = "__Advanced-Tanks__/graphics/entity/tank-rocket/tank-rocket.png",
      frame_count = 1,
      width = 10,
      height = 30,
      priority = "high"
    ...
    shadow =
    {
      filename = "__Advanced-Tanks__/graphics/entity/tank-rocket/tank-rocket-shadow.png",
      frame_count = 1,
      width = 10,
      height = 30,
      priority = "high"
 ...
 --WMD-Mortar
 {
    ...
    animation =
    {
      filename = "__Advanced-Tanks__/graphics/icons/tank-ammo-wmd.png",
      frame_count = 1,
      width = 32,
      height = 32,
	  scale = 1,
