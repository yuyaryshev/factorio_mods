...
LOCO_ENTITY_NAME2 = "atomic-shuttle"
...
script.on_event(defines.events.on_built_entity, function(event)
  if event.created_entity.name == LOCO_ENTITY_NAME or event.created_entity.name == LOCO_ENTITY_NAME2 then
    add_loco(event.created_entity)
  end
end)

script.on_event(defines.events.on_preplayer_mined_item, function(event)
  if event.entity.name == LOCO_ENTITY_NAME or event.entity.name == LOCO_ENTITY_NAME2 then
