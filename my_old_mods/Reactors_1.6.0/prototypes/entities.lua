...
turbine.fast_replaceable_group = "turbine"
...
peak_turbine = util.table.deepcopy(turbine)
peak_turbine.name = "peak-turbine"
peak_turbine.icons =
{
  {
    icon = "__base__/graphics/icons/steam-engine.png",
...
peak_turbine.minable.result = "peak-turbine"
peak_turbine.energy_source.usage_priority = "secondary-output"
peak_turbine.vertical_animation =
{
  layers =
  {
    {
...
peak_turbine.horizontal_animation =
{
  layers =
  {
    {
